    ...
    <div className="container border-top mt-5">
      <div className="row mt-5">
        ...
        <div className="col">
          ...
          <br />
          <a href="" style={{textDecoration: "none"}}>Referral</a>
          <br />
      ...
      <div className="mt-5 text-muted" style={{fontSize:"14px"}}>
        ...
        <p>
          ...
          transactions directi the end of the day. Issued in the interest of
          investors. KYC is one time exercise while dealing in securities
          markets once KYC is done through a SEBI registered interi you need not
          undergo the same process again when you approach another
          intermediary." Dear Investor, if you are subscribing to an IPO, there
          is no need to issue a ch number and sign the IPO application form to
          authorize your bank to make payment in case of allotment. In case of
          non allotment the funds will remain in your bank accou tips, and have
